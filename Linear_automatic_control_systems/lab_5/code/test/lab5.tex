...
plot(out_h.y.Time, out_h.y.Data, "b", ...
     LineWidth=3, ...
     DisplayName="$h(t)$, modeling");

t = out_h.y.Time;
plot(t, K*(1 - exp(-t/T)), "r--", ...
     LineWidth=3, ...
     DisplayName="$h(t)$, analytic");
...
set(gca, FontSize=14);
exportgraphics(gcf, "images/plot_dpt_h.png", Resolution=200);
hold off;
...
plot(out_w.w.Time, out_w.w.Data, "b", ...
     LineWidth=3, ...
     DisplayName="$w(t)$, modeling");

t = out_w.w.Time;
plot(t, (K/T)*exp(-t/T), "r--", ...
     LineWidth=3, ...
     DisplayName="$w(t)$, analytic");
...
set(gcf, Position=[100 100 1200 600]);
set(gca, FontSize=14);
exportgraphics(gcf, "images/plot_dpt_w.png", Resolution=200);
hold off;
\end{matlabcode}
...
t = out_h.y.Time;
wd = sqrt(1 - xi^2)/T;
h_anal = K * (1 - exp(-xi*t/T) .* (cos(wd*t) + (xi/sqrt(1-xi^2))*sin(wd*t)));
plot(t, h_anal, "r--", ...
     LineWidth=3, ...
     DisplayName="$h(t)$, analytic");
...
set(gcf, Position=[100 100 1200 600]);
set(gca, FontSize=14);
exportgraphics(gcf, "images/plot_dpt2_h.png", Resolution=200);
hold off;
...
t = out_w.w.Time;
wd = sqrt(1 - xi^2)/T;
w_anal = (K/(T*sqrt(1-xi^2))) * exp(-xi*t/T) .* sin(wd*t);
plot(t, w_anal, "r--", ...
     LineWidth=3, ...
     DisplayName="$w(t)$, analytic");
...
set(gcf, Position=[100 100 1200 600]);
set(gca, FontSize=14);
exportgraphics(gcf, "images/plot_dpt2_w.png", Resolution=200);
hold off;
\end{matlabcode}
...
set(gcf, Position=[100 100 1200 600]);
set(gca, FontSize=14);
exportgraphics(gcf, "images/plot_cap_h.png", Resolution=200);
hold off;
...
set(gcf, Position=[100 100 1200 600]);
set(gca, FontSize=14);
exportgraphics(gcf, "images/plot_cap_w.png", Resolution=200);
hold off;
\end{matlabcode}
...
set(gcf, Position=[100 100 1200 600]);
set(gca, FontSize=10);
exportgraphics(gcf, "images/plot_spring_h.png", Resolution=200);
hold off;
...
set(gcf, Position=[100 100 1200 600]);
set(gca, FontSize=10);
exportgraphics(gcf, "images/plot_spring_w.png", Resolution=200);
hold off;
\end{matlabcode}
...
set(gcf, Position=[100 100 1200 600]);
set(gca, FontSize=14);
exportgraphics(gcf, "images/plot_pi_h.png", Resolution=200);
hold off;
...
ylim([1.4, 1.5]);
xlim([0, simtime]);
exportgraphics(gcf, "images/plot_pi_w.png", Resolution=200);
hold off;
\end{matlabcode}
