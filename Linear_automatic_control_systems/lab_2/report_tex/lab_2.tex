...
\end{matlabcode}
\begin{center}
\includegraphics[width=\maxwidth{120.42147516307075em}]{figure_1.eps}
\end{center}
\begin{matlabcode}
...
\end{matlabcode}
\begin{center}
\includegraphics[width=\maxwidth{120.42147516307075em}]{figure_3.eps}
\end{center}
...
plot(plot_3.g_ref.Time, plot_3.g_ref.Data, LineWidth=3, LineStyle="-", DisplayName="Задание формулой");
hold on;
plot(plot_3.y.Time, plot_3.y.Data, LineWidth=3, LineStyle="--", DisplayName="Выход генератора");
...
\end{matlabcode}
\begin{center}
\includegraphics[width=\maxwidth{120.42147516307075em}]{figure_4.eps}
\end{center}
\begin{matlabcode}
simtime = 100;
solver_time = 0.001;
...
plot(plot_3.y.Time, plot_3.g_ref.Data - plot_3.y.Data, LineWidth=2, LineStyle="-", color="red", DisplayName="Ошибка(шаг по времени 0.001)");
...
\end{matlabcode}
\begin{center}
\includegraphics[width=\maxwidth{120.42147516307075em}]{figure_5.eps}
\end{center}
\begin{matlabcode}
simtime = 100;
solver_time = 0.00001;
...
plot(plot_3.y.Time, plot_3.g_ref.Data - plot_3.y.Data, LineWidth=1, LineStyle="-", color="red", DisplayName="Ошибка(шаг по времени 0.00001)");
...
\end{matlabcode}
\begin{center}
\includegraphics[width=\maxwidth{120.42147516307075em}]{figure_6.eps}
\end{center}
