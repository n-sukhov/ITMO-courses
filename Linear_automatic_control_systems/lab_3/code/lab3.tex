...
\begin{par}
\begin{flushleft}
Возьмём структурную схему из \textbf{Задания 1 Лабораторной работы 2} для наших входных значений  $u(t)$ (см. рис. \&\&\&). 
\end{flushleft}
\end{par}
...
\begin{par}
\begin{flushleft}
\texttt{Выполним для них моделирование движения системы согласно данным нам начальным условиям и входным воздействиям и посмотрим на полученные графики:}
\end{flushleft}
\end{par}

\begin{itemize}
\setlength{\itemsep}{-1ex}
   \item{\begin{flushleft} \texttt{Набор 2 на рис. \&\&\& - \&\&\&} \end{flushleft}}
\end{itemize}
...
\begin{itemize}
\setlength{\itemsep}{-1ex}
   \item{\begin{flushleft} \texttt{Набор 3 на рис. \&\&\& - \&\&\&} \end{flushleft}}
\end{itemize}
...
\begin{itemize}
\setlength{\itemsep}{-1ex}
   \item{\begin{flushleft} \texttt{Набор 4 на рис. \&\&\& - \&\&\&} \end{flushleft}}
\end{itemize}
...
\begin{par}
\begin{flushleft}
Выберем следующие набора полюсов $\lambda_1 ,\lambda_2 ,\lambda_2$: $\lbrace \lbrace -1,-1,-1\rbrace ,\lbrace -1,-1,-3\rbrace ,\lbrace -1,-3,-5\rbrace ,\lbrace -1,-1+4i,-1-4i\rbrace ,\lbrace -4,-1+4i,-1-4i\rbrace ,\lbrace -4,-1+8i,-1-8i\rbrace \rbrace$
\end{flushleft}
\end{par}
