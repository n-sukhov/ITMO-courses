...
\begin{equation}
  \begin{aligned}
    ...
    \lambda_2&\approx-30.3584,\\
    \lambda_3&\approx-32.7041.
  \end{aligned}
\end{equation}

Поскольку одно собственное значение положительно, а два других отрицательны,
точка $\bm x^{(2)}$ является неустойчивой седловой точкой.
