...
\section{Приложение}
\begin{code}
	\inputminted[breaklines=true, xleftmargin=1em, linenos, frame=single, framesep=10pt, fontsize=\tiny, firstline=1, lastline=720]{python}{/home/ns/Desktop/ITMO-courses/Fourier_Methods/Lab4/tex/Lab4_tex/listings/listing_lab4.py}
	\caption{Листинг}
\end{code}